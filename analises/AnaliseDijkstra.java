...
public class AnaliseDijkstra implements RoxAnalise {


    public AnaliseDijkstra(){}
    ...
    public void shortestPath ( ArrayList nodes, ArrayList edges, int startPosition, int endPosition ) {
